...
function updateContent(lang) {
  ...
  const portfolioDescriptions = [t.portfolio.paloma, t.portfolio.special, t.portfolio.orlandis, t.portfolio.mmk, t.portfolio.avenue];

  portfolioItems.forEach((item, index) => {
    const staticSpan = item.querySelector('.portifoliohead h2 span');
    if (staticSpan) staticSpan.textContent = t.portfolio.static;
